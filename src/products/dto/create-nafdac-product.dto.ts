...
export class CreateNafdacProductDto {
  ...
  @ApiProperty({
    example: 'Analgesic and antipyretic tablets.',
    maxLength: 3000,
  })
  @IsString()
  @MinLength(10)
  ...
  @ApiProperty({
    description: 'Real-world width — used to scale the 3D model.',
    example: 5,
    minimum: 0,
  })
  @Type(() => Number)
  ...
  @ApiProperty({
    description: 'Real-world height — used to scale the 3D model.',
    example: 9,
    minimum: 0,
  })
  @Type(() => Number)
  ...
  @ApiPropertyOptional({
    enum: LengthUnit,
    default: LengthUnit.CM,
    example: LengthUnit.CM,
  })
  @IsOptional()
  @IsEnum(LengthUnit)
