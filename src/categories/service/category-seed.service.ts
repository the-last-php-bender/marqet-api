...
const DEFAULT_CATEGORIES = [
  {
    name: 'Drugs',
    requiresNafdac: true,
    description: 'Medicines, supplements and related health products.',
  },
  {
    name: 'Food & Beverages',
    requiresNafdac: true,
    description: 'Packaged food and drinks regulated by NAFDAC.',
  },
  {
    name: 'Cosmetics',
    requiresNafdac: true,
...
export class CategorySeedService implements OnApplicationBootstrap {
  ...
  async onApplicationBootstrap(): Promise<void> {
    ...
    this.logger.log(
      `Category seed ensured (${DEFAULT_CATEGORIES.length} defaults available).`,
    );
  }
}
