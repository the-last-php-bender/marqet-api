...
export class OrderController {
  ...
  @ApiResponse({
    ...
    description: 'A product is not purchasable yet.',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'One or more products do not exist.',
  })
  async create(
  ...
  @ApiOperation({
    ...
    description:
      'Visible to the buyer, any seller with an item on the order, and admins.',
  })
  @ApiResponse({
  ...
  @ApiResponse({
    ...
    description: 'Not your order and you do not sell on it.',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
  ...
  @ApiOperation({
    ...
    description:
      'Lifecycle: PENDING → PROCESSING → SHIPPED → DELIVERED, with CANCELLED allowed until shipped.',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiResponse({
    status: HttpStatus.FORBIDDEN,
    description: 'You do not sell on this order.',
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Order not found.',
